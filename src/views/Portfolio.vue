  ...
  <div class="portfolio-page">
    ...
    <div v-if="activeSeason === '2023-2024'" class="season-content">
      ...
      <section class="content-section">
        ...
        <p class="intro-text">
          <strong>CenterStage (2023-24):</strong> Robots collect hexagonal
          pixels and place them on backdrops, create mosaics, and launch paper
          drones.
        </p>
        <CenterStageFieldAnimation />
        <MoreInfoPopup
          title="CenterStage Detailed Rules"
          buttonText="More Info"
        >
          <p>{{ t.centerstageGameDetails }}</p>
          <ul>
            <li>
              <strong>Autonomous:</strong> Place purple pixel on spike mark (10
              pts) or team-prop (20 pts); pixels backstage (3 pts) or backdrop
              (5 pts)
            </li>
            <li>
              <strong>Teleop:</strong> Place pixels backstage (1 pt) or backdrop
              (3 pts); create mosaics (10 pt bonus); cross height lines (10
              pts/line)
            </li>
            <li>
              <strong>Endgame:</strong> Launch drones over truss (variable pts);
              parking positions (10-30 pts); suspend from rigging (20 pts)
            </li>
          </ul>
        </MoreInfoPopup>
      </section>
      ...
      <section class="content-section">
        ...
        <p class="strategy-goal">
          <strong>Goal:</strong> {{ t.centerstageGoal }}
        </p>
        ...
        <div class="strategy-phase">
          <h3>Autonomous</h3>
          <p>
            Start with pre-loaded pixel. Follow timing-based trajectory to park
            backstage and drop pixel.
          </p>
        ...
        <div class="strategy-phase">
          <h3>Teleop</h3>
          <p>
            Navigate through truss/stage door, collect pixels, place on
            backdrop. Focus on mosaics and height lines.
          </p>
        ...
        <div class="strategy-phase">
          <h3>Endgame</h3>
          <p>
            Score pixels for 15-20 seconds, then launch drone and park
            backstage.
          </p>
      ...
      <section class="content-section">
        ...
        <Model3DPlaceholder
          title="3D Model: Complete Robot - CenterStage"
          description="Explore the full robot design in 3D"
        />

        <div class="evolution-component">
          <h3>Chassis</h3>
          <p>
            <strong>Final Solution:</strong> Mecanum wheel drive with spacious
            layout and proper hub mounting.
          </p>
          <ChassisEvolutionAnimationEnhanced />
          <MoreInfoPopup title="Design Evolution: Chassis">
            <p>
              Initial X-drive chassis was cramped. Control Hub attached with
              single screw and zip-tie, making it fragile. Solved by redesigning
              with mecanum wheels, adding Expansion Hub, and creating custom
              mounting holders.
            </p>
          </MoreInfoPopup>
        </div>
        ...
        <div class="evolution-component">
          <h3>Intake</h3>
          <p>
            <strong>Final Solution:</strong> Angled "crab claw" with toothed
            wheels for reliable pixel capture.
          </p>
          <IntakeEvolutionAnimationEnhanced />
          <MoreInfoPopup title="Design Evolution: Intake">
            <p>
              <strong>V1 - Dynamic Brush:</strong> Spinning shaft with
              toilet-brush head. Abandoned due to motor limitations (no
              expansion hub).
            </p>
            <p>
              <strong>V2 - Precision Claw:</strong> Single-pixel claw with
              position servo. Required too-precise alignment.
            </p>
            <p>
              <strong>V3 - Angled Claw:</strong> Scissor mechanism with
              counter-rotating gears. More forgiving capture angle.
            </p>
          </MoreInfoPopup>
        </div>
        ...
        <div class="evolution-component">
          ...
          <p>
            <strong>Final Solution:</strong> Tetrix 40:1 motor-powered
            pantograph maintaining constant angle.
          </p>
          <PantographArmAnimationEnhanced />
          <MoreInfoPopup title="Design Evolution: Pantograph Arm">
            <p>
              Initially one continuous-rotation servo (lacked torque). Upgraded
              to two servos in parallel. After obtaining Expansion Hub, replaced
              with Tetrix 40:1 motor for greater lifting power.
            </p>
          </MoreInfoPopup>
        </div>
        ...
        <div class="evolution-component">
          ...
          <p>
            <strong>Final Solution:</strong> Elastic band mechanism with
            servo-controlled release rod.
          </p>
          <DroneLauncherAnimationEnhanced />
          <MoreInfoPopup title="Design Evolution: Drone Launcher">
            <p>
              V1: Basic design. V2: Added custom mounting holes to secure
              launcher to chassis. Elastic held under tension by position servo,
              armed during match, released in endgame.
            </p>
          </MoreInfoPopup>
        </div>
      ...
      <section class="content-section">
        ...
        <p>
          <strong>Autonomous:</strong> Timing-based movements (no
          odometry/vision). 4 programs for different starting positions.
        </p>
        <p>
          <strong>Teleop:</strong> Driver 1 handles movement and arm; Driver 2
          handles intake and drone.
        </p>
        ...
        <MoreInfoPopup title="Programming Challenges" buttonText="More Info">
          ...
          <p>
            <strong>Phone Power Issue:</strong> Motorola G4 Play couldn't power
            two controllers. Solved by switching to Nokia 5 and redistributing
            tasks.
          </p>
        </MoreInfoPopup>
      </section>
      ...
      <section class="content-section team-credits">
        <h2 class="section-title">
          All of this was possible thanks to these people:
        </h2>
      ...
      <CollapsibleSection title="Sustainability & Funding">
        <p>
          Fundraising through bake sales, movie nights, and school sponsorship.
          First corporate sponsor: Professional Dentist. Focus on recruiting
          younger members and building alumni support network.
        </p>
      </CollapsibleSection>
    </div>
    ...
    <div v-if="activeSeason === '2024-2025'" class="season-content">
      ...
      <section class="content-section">
        <h2 class="section-title">How the Games Work</h2>
        <p class="intro-text">
          <strong>Into the Deep (2024-25):</strong> Robots collect samples,
          score in baskets/chambers, and climb the submersible.
        </p>
        <IntoTheDeepFieldAnimation />
        <MoreInfoPopup
          title="Into the Deep Detailed Rules"
          buttonText="More Info"
        >
          <p>{{ t.intoTheDeepGameDetails }}</p>
          <ul>
            <li>
              <strong>Scoring:</strong> Samples in net zones (2 pts), low basket
              (4 pts), high basket (8 pts)
            </li>
            <li>
              <strong>Specimens:</strong> Clips attached by human players. Low
              chamber (6 pts), high chamber (10 pts)
            </li>
            <li>
              <strong>Endgame:</strong> Touch low rung (3 pts), low-level ascent
              (15 pts), high-level ascent (30 pts), park in observation (3 pts)
            </li>
          </ul>
        </MoreInfoPopup>
      </section>
      ...
      <section class="content-section">
        ...
        <Model3DPlaceholder
          title="3D Model: Complete Robot - Into the Deep"
          description="Explore the full robot design in 3D"
        />
        ...
        <div class="evolution-component">
          <h3>Intake System</h3>
          <p>
            <strong>Final Solution:</strong> Lightweight rotating blades with
            3D-printed disc stabilizers.
          </p>
          <BladeStabilizationAnimationEnhanced />
          <MoreInfoPopup title="Design Evolution: Intake System">
            <p>
              <strong>First Version Issues:</strong> Oversized claw couldn't
              close fully, specimens fell. Heavy butcher-shop blades acted as
              obstacles, often aligned parallel and failed to grab.
            </p>
            <p>
              <strong>Solution:</strong> Redesigned claw shape, added structural
              support, replaced blades with stoppers, created 3D-printed
              hexagonal discs to lock blades at 90°.
            </p>
          </MoreInfoPopup>
        </div>
        ...
        <div class="evolution-component">
          <h3>Slider System</h3>
          <p>
            <strong>Final Solution:</strong> Single vertical slider with
            integrated arm.
          </p>
          <SliderSystemAnimationEnhanced />
          <MoreInfoPopup title="Design Evolution: Slider System">
            <p>
              <strong>First Version:</strong> Dual sliders (horizontal +
              vertical), off-center, wobbly, storage box didn't reach basket.
            </p>
            <p>
              <strong>Solution:</strong> Eliminated horizontal slider. Single
              vertical slider with attached arm. No transfer between
              containers—intake grabs and slider lifts directly to high basket.
            </p>
          </MoreInfoPopup>
        </div>
        ...
        <div class="evolution-component">
          ...
          <p>
            <strong>Final Solution:</strong> Winch-driven hook system for
            submersible ascent.
          </p>
          <HangingMechanismAnimationEnhanced />
          <MoreInfoPopup title="Design Evolution: Hanging Mechanism">
            <p>
              <strong>Challenge:</strong> Endgame requires climbing the
              submersible for significant points (touch: 3 pts, low-level
              ascent: 15 pts, high-level ascent: 30 pts).
            </p>
            <p>
              <strong>Solution:</strong> Implemented a motorized winch system
              with extendable cable and hook. Hook extends upward to latch onto
              rung, then winch retracts cable to lift robot off the ground.
              Reliable and consistent for competition.
            </p>
          </MoreInfoPopup>
        </div>
        ...
        <div class="evolution-component">
          ...
          <p>
            <strong>Final Solution:</strong> Three-stage telescoping arm with
            servo-controlled gripper for horizontal reach.
          </p>
          <ExtendableArmAnimationEnhanced />
          <MoreInfoPopup title="Design Evolution: Extendable Arm">
            <p>
              <strong>Challenge:</strong> Need to reach samples from the
              submersible while maintaining compact robot size for
              maneuverability.
            </p>
            <p>
              <strong>Solution:</strong> Designed a 3-stage telescoping
              horizontal arm that extends up to 40cm. Linear actuator motor
              provides smooth extension/retraction. Servo-controlled gripper at
              end provides precise sample capture with force-sensing to avoid
              damage. Arm retracts fully into robot chassis when not in use,
              keeping within size constraints.
            </p>
            <p>
              <strong>Key Features:</strong> Telescoping design for maximum
              reach with minimum stored length. Integrated gripper with
              open/close capability. Rails guide each stage for stability. Can
              interface with both intake system and vertical slider for
      ...
      <section class="content-section">
        <h2 class="section-title">Programming Approach</h2>
        <p>
          <strong>Autonomous:</strong> Timing-based with 4 cases (forward,
          backward, left, right) combined based on starting position.
        </p>
        <p>
          <strong>Teleop:</strong> Driver 1 handles movement; Driver 2 handles
          slider and intake/outtake.
        </p>
      ...
      <CollapsibleSection title="Lessons Learned & Growth">
        <p>
          Applied lessons from CenterStage to streamline mechanisms. Focused on
          weight distribution and reliability. Adopted 3D-printed improvements.
          Programming evolved to multi-case autonomous routines.
        </p>
      </CollapsibleSection>

      <CollapsibleSection title="Future Outlook">
        <p>
          Integration of sensors for autonomous navigation could improve
          scoring. Corporate sponsorships may fund advanced motors and vision
          systems. Sustainability plan ensures continued growth.
        </p>
      </CollapsibleSection>

      <CollapsibleSection title="Sustainability & Funding">
        <p>
          Continued fundraising through sales and events. Expanded sponsor
          network. Focus on recruiting younger students and maintaining alumni
          support.
        </p>
      </CollapsibleSection>
    </div>
    ...
    <div v-if="activeSeason === '2025-2026'" class="season-content">
      <section class="content-section upcoming-season">
        ...
        <div class="coming-soon">
          ...
          <p>
            The 2025-2026 FTC season game will be revealed soon. Stay tuned for
            our robot design, strategy, and journey documentation.
          </p>
          <div class="placeholder-areas">
            <div class="placeholder-box">
              <h4>Game Overview</h4>
              <p>
                Game mechanics and field layout will be added once announced
              </p>
            </div>
            <div class="placeholder-box">
              <h4>Robot Design</h4>
