...
export type Translation = {
  ...
  centerstageStrategySummary: Array<{
    period: string;
    mandatory: string[];
    optional: string[];
    scoring: string;
  ...
  intoTheDeepStrategySummary: Array<{
    period: string;
    mandatory: string[];
    optional: string[];
    scoring: string;
...
export const translations: { en: Translation; ro: Translation } = {
  en: {
    ...
    homeWelcome:
      "We design, build and race robots that teach teamwork, engineering and creativity.",
    aboutTitle: "About Us",
    aboutText:
      "We combine hands-on learning with competition-grade engineering to help students build real robots, real skills and lasting careers. Join our workshops, sponsor our growth, or meet the team building tomorrow's robotics leaders.",
    ...
    activities: [
      {
        name: "Paradis Run",
        description:
          "Community running event promoting health and school spirit, bringing together students, families, and community members for a day of fitness and fun",
      },
      {
        name: "Annual Movie Night",
        description:
          "School-wide event bringing together students and families for entertainment and community building, featuring robotics-themed films and demonstrations",
      },
      {
        name: "Iași Meet",
        description:
          "Regional robotics meetup with other FTC teams in Iași, sharing knowledge, strategies, and building relationships with fellow roboticists",
      },
      {
        name: "Initiative to Give Sweets and Books",
        description:
          "Community outreach program sharing joy and education with local children, promoting literacy and STEM awareness in our community",
      },
      {
        name: "FTC Regionals 2025",
        description:
          "Competitive robotics tournament representing our school and region, showcasing our technical achievements and gracious professionalism on the field",
      },
    ],
    ...
    ambassadorStatement:
      "We represent our team, Paradise College, and Nație prin Educație. We embody STEM education and gracious professionalism in every interaction.",
    valuesClosing:
      "These values guide our daily work, from designing and building our robot to engaging with sponsors and conducting outreach programs. They remind us that success in FTC is measured not just by competition results, but by the positive impact we make on each other and our community.",
    ...
    achievementsList: [
      {
        ...
        description:
          "Founded Mechabyte 22590 at Paradise International College.",
      },
      {
        year: "2024",
        title: "First Robot Build",
        description:
          "Built first competitive FTC robot for INTO THE DEEP season.",
      },
      {
        year: "2024",
      ...
      },
      {
        ...
        description:
          "Competed in FTC Regionals 2025, showcased technical excellence.",
      },
      {
        year: "Ongoing",
        title: "STEM Workshops",
        description:
          "Host regular robotics workshops for middle-school students.",
      },
      {
        year: "Ongoing",
        title: "Technical Development",
        description:
          "Continuously improve robot design through testing and iteration.",
      },
    ],
    ...
    teamCollaboration:
      "Last season, our CAD designer sketched a grabber mechanism on a napkin during lunch.\n\nBy evening, the programming team had simulated it. Next day, marketing filmed the prototype test.\n\nThis is how we work—ideas flow freely, no silos.\n\nMarketing helps debug code when fresh eyes are needed. Engineers brainstorm social media campaigns.\n\nOur weekly sync-ups are chaotic, energetic, and productive. Everyone contributes beyond their role.",
    trainingTitle: "Training New Members",
    teamTraining:
      "Day 1: Welcome chaos. New juniors are handed tools, not manuals.\n\nWeek 1-4: Seniors guide hands-on builds. Juniors solder their first circuit, write their first autonomous code, design their first CAD part.\n\nMonth 2-3: Juniors lead small projects. They mess up, debug, iterate. Seniors supervise but don't rescue.\n\nMonth 4-6: Juniors become confident. They start teaching the next wave.\n\nBy season end, yesterday's juniors are today's seniors. Tomorrow, they're team leaders.",
    teamEnvironmentTitle: "Team Environment",
    teamEnvironment:
      "Picture this: It's 11PM. Robot deadline is tomorrow.\n\nHalf the team is debugging motor stalls. The other half is making memes about it.\n\nSomeone orders pizza. Someone else plays terrible music. Everyone laughs.\n\nWe fail together. We celebrate together. We build together.\n\nBeyond the circuits and competitions, we're building friendships that outlast high school.\n\nSome of our best memories aren't victories—they're the 3AM breakthroughs and inside jokes that only we understand.",

    technicalTeamDesc2025:
      "Building and programming robots for the 2025-2026 season. Focus on innovative designs and reliable autonomous systems.",
    nonTechnicalTeamDesc2025:
      "Managing outreach, marketing, and team branding. Creating compelling content and building community partnerships.",
    mentorsDesc2025:
      "Guiding the team with technical expertise and strategic direction. Supporting both competition and team development goals.",
    technicalTeamDesc2024:
      "Designed and built the Into the Deep robot. Developed vertical slider intake system and optimized scoring mechanisms.",
    nonTechnicalTeamDesc2024:
      "Managed social media campaigns, organized fundraising events, and coordinated outreach activities throughout the season.",
    mentorsDesc2024:
      "Provided technical guidance and mentorship during Into the Deep season. Helped team navigate competition challenges.",
    technicalTeamDesc2023:
      "Created the CenterStage robot with pantograph arm and drone launcher. Pioneered mecanum drive chassis design.",
    nonTechnicalTeamDesc2023:
      "Led marketing initiatives, fundraising events, and community engagement during the team's founding season.",
    mentorsDesc2023:
      "Founded and established the team. Provided initial training and guided first season competition participation.",

    sponsorsTitle: "Our Sponsors",
    sponsorsIntro:
      "Partner with Mechabyte — strengthen local STEM, gain tax benefits and connect with bright talent.",
    ...
    becomeSponsorText:
      "Invest in Romanian robotics and shape tomorrow's tech workforce!",

    supportTitle: "Support Our Mission",
    supportIntro:
      "There are many ways to support Mechabyte and contribute to STEM education in our community. Whether through financial sponsorship, volunteer time, equipment donations, or mentorship, your support makes a real difference.",
    ...
    volunteerText:
      "We welcome volunteers who want to share their expertise with our team. Whether you have experience in engineering, programming, marketing, or business, your guidance can help our members develop valuable skills. Volunteers can participate in workshops, provide technical mentorship, or assist with event planning and execution.",
    donateTitle: "Equipment & Material Donations",
    donateText:
      "Hardware donations are incredibly valuable to our team. We can always use components such as motors, sensors, aluminum extrusions, fasteners, electronics, and tools. Even outdated equipment can be useful for prototyping and learning. If you or your organization has surplus materials that could benefit a robotics team, please reach out to us.",
    mentorshipTitle: "Mentorship Programs",
    mentorshipText:
      "Professional mentors provide invaluable guidance to help our team grow. Mentors can work with specific sub-teams (programming, CAD, marketing) or provide overall guidance on project management, team dynamics, and strategy. Mentorship can be as involved or flexible as your schedule allows, from weekly meetings to occasional check-ins and competition attendance.",
    taxDeductibleTitle: "Tax Benefits",
    taxDeductibleText:
      "Contributions to Mechabyte may be tax-deductible as supporting educational initiatives. We provide all necessary documentation for your records. Contact us to learn more about how your contribution can benefit both our team and your organization.",

    contactTitle: "Get In Touch",
    contactIntro:
      "We would love to hear from you! Whether you are interested in sponsoring our team, volunteering, scheduling a robot demonstration, or simply learning more about what we do, please reach out through any of the channels below.",
    contactDetails: {
      email: "mechabyte22590@gmail.com",
      phone: "+40773854312 (Andreea Ionita)",
      address:
        "Str. Dealul Zorilor 8C, Mechabyte – Paradise International College, Iași",
    ...
    scheduleDemo:
      "See our robot in action! Book a demo for your school or event. We bring robotics to life.",
    stayConnectedTitle: "Stay Connected",
    connectWithUs:
      "Follow our journey: competitions, builds, behind-the-scenes. Join the community!",
    ...
    featureCompetitionDesc:
      "Preparing for FTC competitions with rigorous testing, iteration, and strategic planning.",

    // Portfolio page
    portfolioTitle: "Mechabyte #22590",
    portfolioSubtitle: "Engineering Portfolio – Centerstage & Into the Deep",
    portfolioMission:
      "Mechabyte was founded on September 25, 2023, during Science Week at Paradise International College. Our team was created to learn and discover new skills while having fun. We aim to implement STEM core values—responsibility, compassion, and perseverance—constantly improve our capabilities, and inspire future generations to follow their dreams in science, technology, engineering, and mathematics.",
    ...
    portfolioIntoTheDeepNonTechnical:
      "Non-Technical: Alexandra Maftei, Veronika Glazkova, Cristiana Balan, Alexandra Sîmbotin Gășpărel",
    portfolioIntoTheDeepTechnical:
      "Technical: Alexia Vancea, Ianis Cotoc, Teodor Matricală, Catrinel Bănuță, Rareș Berheci",
    portfolioCenterstageMentor: "Mentor: Andreea Ionita",
    portfolioCenterstageNonTechnical:
      "Non-Technical: Aayush Khadka, Alexia Vancea, Alexandra Maftei",
    portfolioCenterstageTechnical:
      "Technical: Maia Sava (Building & Programming), Șerban Untu (Building & Programming), Rareș Cozma (Building), Cristian Ghidireac (Building & Design), David Grigore (Design & Building), Ștefan Albu (Design)",

    // Game strategy content
    centerstageGoal:
      "Since this is the first season in which we participate, our goal for the robot was to score as many points as possible.",
    centerstageAutonomousDetails:
      "We start off with a pre-loaded pixel in the intake claw. As we don't have any odometry, we programmed the robot on timing. Depending on the starting position, the robot will follow a preset trajectory in order to park in the backstage, and drop the pixel there. We have a total of 4 Autonomous programmes for each trajectory (2 which do the same thing).\n\nFirst starting position (backstage): When placing the robot in the field, it would face the backstage so that it should only go forward until it reached the desired location.\n\nSecond starting position (audience): When placed in the field, the robot would face towards the other alliance. The trajectory we established was going forward until tile C2 and then sideways until reaching the backstage.",
    centerstageTeleOpDetails:
      "Depending on our alliance, the strategy slightly varies. In essence the drivers will navigate through the truss and/or stage door to get one pixel at a time from either stacks or the human station. After successfully loading the pixel, the drivers would carefully navigate towards the backstage and place the pixel in the backdrop. If the pixel happens to fall in the backstage, the drivers will leave it there and focus to bring another pixel. If possible, the drive team will try to create mosaics and pass one line from the backdrop for the bonus points.",
    centerstageEndgameDetails:
      "During the first 15-20 seconds, the drivers will keep scoring pixels in the backdrop. In the final few seconds, the drone will be launched and the robot parked in the backstage.",
    centerstageStrategySummary: [
      {
        period: "Autonomous",
        mandatory: ["park robot in backstage"],
        optional: ["drop pre-loaded pixel in backstage"],
        scoring: "5 - 8 pts",
      },
      {
        period: "Teleop",
        mandatory: ["place as many pixels on backdrop"],
        optional: [
          "place pixel in backstage",
          "form mosaics",
          "pass lines on backdrop",
        ],
        scoring: "9 - 15 pts",
      },
      {
        period: "Endgame",
        mandatory: ["launch drone", "park robot in backstage"],
        optional: [],
        scoring: "5 - 35 pts",
      },
    ],
    centerstageAutonomous:
      "Robot starts with a pre-loaded pixel in the intake claw. No odometry is used; all movements are based on timing. We have two main starting positions: backstage-facing (drive straight to park and drop pixel) and audience-facing (drive forward to tile C2, then sideways to backstage).",
    centerstageTeleOp:
      "Drivers navigate through the truss or stage door to collect pixels from stacks or the human station. We deliver one pixel at a time to the backdrop. If a pixel falls in backstage, we leave it and fetch another. Our goal is to form mosaics and cross lines on the backdrop for bonus points.",
    centerstageEndgame:
      "We continue scoring pixels for 15-20 seconds, then launch the drone and park in backstage for additional points.",
    intoTheDeepGoal:
      "Score as many points as possible by collecting samples and scoring in baskets/chambers, then climbing the submersible.",
    intoTheDeepAutonomousDetails:
      "Robot starts from observation zone near the submersible. Using timing-based navigation, it moves to the submersible center (~1.5s), collects one sample, then delivers to the net zone (~2.0s total). The sample dropped in the net zone scores 2 points. Total autonomous time is approximately 3.5 seconds.",
    intoTheDeepTeleOpDetails:
      "Drivers navigate to collect samples one at a time from the submersible or field floor. Samples are scored in the high basket (8 pts each) for maximum efficiency. The vertical slider extends to reach the basket while the intake system releases the sample. If a sample is dropped, we abandon it and collect a new one rather than waste time retrieving it.",
    intoTheDeepEndgameDetails:
      "Continue scoring samples in the high basket until 15-20 seconds remain. In the final seconds, park the robot in the net zone (3 pts) or attempt a low-level ascent on the submersible ladder (15 pts) if time permits.",
    intoTheDeepStrategySummary: [
      {
        period: "Autonomous",
        mandatory: ["park robot in netzone or level 1 ascend"],
        optional: ["place sample in net zone"],
        scoring: "3 pts",
      },
      {
        period: "Teleop",
        mandatory: ["place as many samples in high basket"],
        optional: ["place samples in low basket"],
        scoring: "24 - 48 pts",
      },
      {
        period: "Endgame",
        mandatory: ["park robot in netzone or level 1 ascend"],
        optional: ["level 2 ascend"],
        scoring: "3 - 15 pts",
      },
    ],
    intoTheDeepTeleOp:
      "We navigate to pick up one sample at a time from the field or submersible. Samples are placed in the highest basket in the net zone. If a sample falls, we abandon it and fetch a new one to maximize scoring efficiency.",
    intoTheDeepEndgame:
      "We continue scoring in the high basket until the final seconds, then park in the net zone for additional points.",
    ...
    centerstageIntakeEvolution:
      "First version was a dynamic intake with a spinning shaft and toilet-brush head pushing pixels up a ramp into two-pixel storage. Dropped due to lack of motors (all 4 used by drive train, no expansion hub). Second version used a single-pixel claw with position servo and toothed wheel—more precise but required accurate alignment. Third version featured a claw opening at an angle using two meshed toothed wheels, making pixel grabbing easier.",
    centerstageArmEvolution:
      "Pantograph-inspired arm (like tram pantographs) keeps the intake angle constant while raising or lowering, eliminating constant readjustment needs. Initially powered by one, then two continuous-rotation servos (insufficient torque caused sagging). Later upgraded to a Tetrix 40:1 motor after obtaining the Expansion Hub.",
    centerstageLauncherEvolution:
      "Thin plate with three channels for drone, elastic band, and sliding rod. The elastic is held under tension by the rod; releasing it launches the drone to scoring zones. Rod is attached to a position servo, armed during auto/tele-op, and released during endgame. Second version improved mounting with custom chassis holes.",
    intoTheDeepFirstVersion:
    ...
    intoTheDeepUpgradeAttempts:
      "We redesigned the claw shape to better fit specimens, but sides didn't align well, making gripping difficult. At the first meet, the intake got stuck on the submersible zone edge. The system was too slow, heavy, and fragile. We chose not to use the claw due to these issues.",
    intoTheDeepCurrentVersion:
      "Simplified design with a single vertical slider and attached arm. No transfer between containers—intake grabs sample and slider lifts directly to high basket. Benefits: easily reach high basket, lighter but more durable intake, straight alignment helps precise scoring. Remaining challenge: arm movement due to imperfect hex motor attachment to slider.",
    intoTheDeepConstructionImprovements:
      "Stabilized intake with two extra structural parts. Replaced butcher-shop blades and added stoppers to prevent parallel turning. Created 3D-printed discs with hexagonal centers to lock blades on shaft, fixing rotation issues.",

    // Programming content
    programmingDescription:
      "Both seasons used time-based autonomous because we had no cameras or sensors. Movements are sequences of forward/back/left/right moves with fixed durations. Sometimes we use reduced power at the end to ensure full parking in the zone or backstage.",
    driverLayoutDescription:
      "Centerstage: Initially a single driver handled all tasks due to phone power-delivery issues with two gamepads (Motorola G4 Play). With a new phone (Nokia 5), we split tasks between driver 1 (movement + arm/launcher) and driver 2 (intake). Into the Deep: Driver 1 controls robot movement and slider extension; driver 2 controls intake, out-take, and arm.",

    // Outreach content
    socialMediaDescription:
      "Our main platforms are Instagram and TikTok. We regularly share progress updates, behind-the-scenes content, and competition highlights. We actively engage with other teams through comments, congratulations, and event promotion. As a result, many teams already recognize Mechabyte at meets.",
    outreachEvents: [
      {
        name: "Movie Night (Home Alone 1)",
        description:
          "Fundraising event at Paradis International College featuring robot showcase and informal STEM discussions.",
      },
      {
        name: "Sweets and Books Initiative",
        description:
          "Donated sweets and books to children in need, combined with informal discussions about robotics and STEM values.",
      },
      {
        name: "Paradis Run (November 2)",
        description:
          "Charity event for Little People Association—team both ran and volunteered.",
      },
      {
        name: "Nikola Tesla Science Festival",
        description:
          "Collaboration with Cyliis and Peppers teams, exchanging advice about FTC.",
      },
      {
        name: "Winter Dive Meet Iași",
        description:
          "Cooperation with regional teams like Cyliis, Peppers, and Robozzi. Scored 3 out of 6 matches.",
      },
      {
        name: "Pancakes and Desserts Sale",
        description:
          "Centerstage season fundraiser that raised approximately 5,000 RON.",
      },
      {
        name: "Christmas Market Decorations",
        description:
          "Sold decorations at Christmas market, raising additional 2,000 RON.",
      },
      {
        name: "Robotics & AI STEMPOSSUM",
        description:
          'Collaboration with Cyliss and Technical University "Gheorghe Asachi".',
      },
      {
        name: "UGAL Inventics Saloon",
        description:
          "Participated with RoSophia team, showcasing our robot and innovations.",
      },
    ],
    fundraisingDescription:
      "Our fundraising activities across both seasons included selling biscuits, Movie Night tickets, pancakes, decorations, and flowers. These events have been crucial in supporting our operational costs and competition participation.",
    sustainabilityDescription:
      "Our sustainability plan focuses on: recruiting and training younger students to ensure continuity, maintaining alumni support network, partnering with corporations that share our values, and careful budgeting with categories for team expenditure (wheels, cables, electronics) and emergency funds. Main sponsors include Paradis International College, Professional Dentist, and others who believe in our mission.",

    // New detailed sections
    ftcOverviewTitle: "What is the FIRST Tech Challenge?",
    ftcOverviewContent:
      "The FIRST Tech Challenge (FTC) is an international robotics contest for high-school students. In each season, small alliances of two teams play short matches on a 12×12 ft field. Each team builds and programs a robot that fits inside an 18 inch cube and may expand during a match. A match begins with a 30 s autonomous period where robots follow pre-programmed instructions; it is followed by a 2 min driver-controlled period where drivers operate the robot with game controllers, and a final 30 s endgame with additional bonus tasks. Teams earn points by manipulating themed game elements and performing optional tasks, while abiding by safety and fairness rules.",
    ...
    intoTheDeepEvents: [
      ...
      },
      {
        ...
        partnerships:
          "Collaborated with Paradise International College parent volunteers for booth setup. Local crafts suppliers provided materials at discounted rates. Iași local government provided free booth space in recognition of our educational mission.",
      },
    ],
  ...
  ro: {
    ...
    aboutText:
      "Combinăm învățare practică cu inginerie de competiție pentru a ajuta studenții să construiască roboți reali, abilități reale și cariere de durată. Alătură-te atelierelor, sponsorizează creșterea noastră sau cunoaște echipa care construiește liderii roboticii de mâine.",
    ...
    ftcDescription:
      "FIRST Tech Challenge (FTC) este o competiție globală de robotică pentru studenți cu vârste între 12-18 ani. Echipele proiectează, construiesc, programează și concurează cu roboți pentru a completa provocări pe un teren de 12x12 picioare (3,7 x 3,7 metri). FTC promovează educația STEM, munca în echipă și profesionalismul grațios, pregătind studenții pentru cariere viitoare în tehnologie și inginerie. Fiecare sezon prezintă o nouă provocare de joc care testează atât abilitățile tehnice, cât și gândirea strategică, necesitând ca echipele să lucreze împreună pentru a rezolva probleme complexe.",
    activitiesTitle: "Activități și Calendar 2024-2025",
    activities: [
      {
        name: "Paradis Run",
        description:
          "Eveniment comunitar de alergare care promovează sănătatea și spiritul școlar, reunind studenți, familii și membri ai comunității pentru o zi de fitness și distracție",
      },
      {
        name: "Seara Anuală de Film",
        description:
          "Eveniment la nivel de școală care reunește studenți și familii pentru divertisment și construirea comunității, prezentând filme cu tematică robotică și demonstrații",
      },
      {
        name: "Iași Meet",
        description:
          "Întâlnire regională de robotică cu alte echipe FTC din Iași, schimbând cunoștințe, strategii și construind relații cu colegi roboticieni",
      },
      {
        name: "Inițiativă de Oferire de Dulciuri și Cărți",
        description:
          "Program de implicare comunitară care împărtășește bucurie și educație copiilor locali, promovând alfabetizarea și conștientizarea STEM în comunitatea noastră",
      },
      {
        name: "FTC Regionals 2025",
        description:
          "Turneu de robotică competitiv reprezentând școala și regiunea noastră, prezentând realizările noastre tehnice și profesionalismul grațios pe teren",
      },
    ],
    ...
    achievementsList: [
      {
        ...
        description:
          "Înființat Mechabyte 22590 la Paradise International College.",
      },
      {
        year: "2024",
        title: "Prima Construcție de Robot",
        description:
          "Construit primul robot competitiv FTC pentru sezonul INTO THE DEEP.",
      },
      {
        year: "2024",
      ...
      },
      {
        ...
        description:
          "Organizat eveniment comunitar Paradis Run la nivel de școală.",
      },
      {
        year: "2024",
        title: "Seara Anuală de Film",
        description:
          "Găzduit seară de film de succes pentru studenți și familii.",
      },
      {
        year: "2025",
      ...
      },
      {
        ...
        description:
          "Concurat în FTC Regionals 2025, demonstrat excelență tehnică.",
      },
      {
        year: "În derulare",
        title: "Workshop-uri STEM",
        description:
          "Găzduim workshop-uri regulate de robotică pentru elevi de gimnaziu.",
      },
      {
        year: "În derulare",
        title: "Dezvoltare Tehnică",
        description:
          "Îmbunătățim continuu designul robotului prin testare și iterație.",
      },
    ],
    ...
    teamCollaboration:
      "Sezonul trecut, designerul nostru CAD a schițat un mecanism pe un șervețel la prânz.\n\nSeara, echipa de programare l-a simulat. A doua zi, marketing-ul a filmat testul prototipului.\n\nAstfel lucrăm—ideile curg liber, fără bariere.\n\nMarketing-ul ajută la debug când sunt necesari ochi proaspeți. Inginerii fac brainstorming pentru campanii social media.\n\nSincronizările noastre săptămânale sunt haotice, energice și productive. Toată lumea contribuie dincolo de rol.",
    trainingTitle: "Instruirea Noilor Membri",
    teamTraining:
      "Ziua 1: Bine ați venit în haos. Juniorii noi primesc unelte, nu manuale.\n\nSăptămâna 1-4: Seniorii ghidează construcții practice. Juniorii lipesc primul circuit, scriu primul cod autonom, proiectează prima piesă CAD.\n\nLuna 2-3: Juniorii conduc proiecte mici. Greșesc, fac debug, iterează. Seniorii supraveghează dar nu salvează.\n\nLuna 4-6: Juniorii devin încrezători. Încep să predea următoarea generație.\n\nLa sfârșitul sezonului, juniorii de ieri sunt seniorii de azi. Mâine, sunt team leaderi.",
    teamEnvironmentTitle: "Mediul Echipei",
    teamEnvironment:
      "Imaginează-ți: E 23:00. Deadline-ul robotului e mâine.\n\nJumătate din echipă face debug la motoare blocate. Cealaltă jumătate face meme-uri despre asta.\n\nCineva comandă pizza. Altcineva pune muzică groaznică. Toți râd.\n\nEșuăm împreună. Sărbătorim împreună. Construim împreună.\n\nDincolo de circuite și competiții, construim prietenii care durează mai mult decât liceul.\n\nUnele dintre cele mai bune amintiri nu sunt victorii—sunt descoperirile de la 3 dimineața și glumele pe care doar noi le înțelegem.",

    technicalTeamDesc2025:
      "Construiește și programează roboți pentru sezonul 2025-2026. Accent pe design-uri inovatoare și sisteme autonome fiabile.",
    nonTechnicalTeamDesc2025:
      "Gestionează activități de outreach, marketing și branding. Creează conținut captivant și parteneriate comunitare.",
    mentorsDesc2025:
      "Ghidează echipa cu expertiză tehnică și direcție strategică. Susține obiectivele de competiție și dezvoltare a echipei.",
    technicalTeamDesc2024:
      "A proiectat și construit robotul Into the Deep. A dezvoltat sistemul de intake cu slider vertical și mecanisme de scoring optimizate.",
    nonTechnicalTeamDesc2024:
      "A gestionat campanii social media, a organizat evenimente de fundraising și a coordonat activități de outreach pe tot sezonul.",
    mentorsDesc2024:
      "A furnizat îndrumare tehnică și mentorat în sezonul Into the Deep. A ajutat echipa să navigheze provocările competiției.",
    technicalTeamDesc2023:
      "A creat robotul CenterStage cu braț pantograf și lansator de drone. A pionierat design-ul șasiului cu roți mecanum.",
    nonTechnicalTeamDesc2023:
      "A condus inițiative de marketing, evenimente de fundraising și engagement comunitar în sezonul de fondare.",
    mentorsDesc2023:
      "A fondat și stabilit echipa. A oferit training inițial și a ghidat participarea în prima competiție.",

    sponsorsTitle: "Sponsorii Noștri",
    sponsorsIntro:
      "Partener cu Mechabyte — întărește STEM-ul local, obține beneficii fiscale și conectează-te cu talente strălucitoare.",
    ...
    becomeSponsorText:
      "Investește în robotica românească și formează forța de muncă tech de mâine!",

    supportTitle: "Susține Misiunea Noastră",
    supportIntro:
      "Există multe modalități de a susține Mechabyte și de a contribui la educația STEM în comunitatea noastră. Fie prin sponsorizare financiară, timp voluntar, donații de echipamente sau mentorat, susținerea dumneavoastră face o diferență reală.",
    ...
    scheduleDemo:
      "Vezi robotul nostru în acțiune! Rezervă o demonstrație pentru școala sau evenimentul tău. Aducem robotica la viață.",
    stayConnectedTitle: "Rămâneți Conectați",
    connectWithUs:
      "Urmărește călătoria noastră: competiții, construcții, în culise. Alătură-te comunității!",
    ...
    featureCompetitionDesc:
      "Pregătire pentru competițiile FTC cu testare riguroasă, iterație și planificare strategică.",

    // Portfolio page
    portfolioTitle: "Mechabyte #22590",
    portfolioSubtitle: "Portofoliu de Inginerie – Centerstage și Into the Deep",
    portfolioMission:
      "Mechabyte a fost înființată pe 25 septembrie 2023, în timpul Săptămânii Științei la Paradise International College. Echipa noastră a fost creată pentru a învăța și descoperi abilități noi distrându-ne. Ne propunem să implementăm valorile fundamentale STEM—responsabilitate, compasiune și perseverență—să ne îmbunătățim constant capacitățile și să inspirăm generațiile viitoare să-și urmeze visele în știință, tehnologie, inginerie și matematică.",
    ...
    portfolioIntoTheDeepNonTechnical:
      "Non-Tehnic: Alexandra Maftei, Veronika Glazkova, Cristiana Balan, Alexandra Sîmbotin Gășpărel",
    portfolioIntoTheDeepTechnical:
      "Tehnic: Alexia Vancea, Ianis Cotoc, Teodor Matricală, Catrinel Bănuță, Rareș Berheci",
    portfolioCenterstageMentor: "Mentor: Andreea Ionita",
    portfolioCenterstageNonTechnical:
      "Non-Tehnic: Aayush Khadka, Alexia Vancea, Alexandra Maftei",
    portfolioCenterstageTechnical:
      "Tehnic: Maia Sava (Construcție și Programare), Șerban Untu (Construcție și Programare), Rareș Cozma (Construcție), Cristian Ghidireac (Construcție și Design), David Grigore (Design și Construcție), Ștefan Albu (Design)",

    // Game strategy content
    centerstageGoal:
      "Deoarece acesta este primul sezon în care participăm, obiectivul nostru pentru robot a fost să marcăm cât mai multe puncte posibil.",
    centerstageAutonomousDetails:
      "Începem cu un pixel pre-încărcat în gheara de colectare. Deoarece nu avem odometrie, am programat robotul pe timp. În funcție de poziția de pornire, robotul va urma o traiectorie presetată pentru a parca în backstage și a lăsa pixelul acolo. Avem în total 4 programe Autonome pentru fiecare traiectorie (2 care fac același lucru).\n\nPrima poziție de pornire (backstage): Când plasăm robotul pe teren, ar fi orientat către backstage astfel încât ar trebui doar să meargă înainte până ajunge la locația dorită.\n\nA doua poziție de pornire (public): Când este plasat pe teren, robotul ar fi orientat către cealaltă alianță. Traiectoria pe care am stabilit-o a fost să mergem înainte până la tile C2 și apoi lateral până la ajungerea la backstage.",
    centerstageTeleOpDetails:
      "În funcție de alianta noastră, strategia variază ușor. În esență, piloții vor naviga prin truss și/sau ușa scenei pentru a obține câte un pixel pe rând fie de la stive, fie de la stația umană. După încărcarea cu succes a pixelului, piloții vor naviga cu atenție către backstage și vor plasa pixelul pe backdrop. Dacă pixelul se întâmplă să cadă în backstage, piloții îl vor lăsa acolo și se vor concentra să aducă un alt pixel. Dacă este posibil, echipa de conducere va încerca să creeze mozaicuri și să treacă o linie de pe backdrop pentru punctele bonus.",
    centerstageEndgameDetails:
      "În primele 15-20 secunde, piloții vor continua să marcheze pixeli pe backdrop. În ultimele câteva secunde, drona va fi lansată și robotul parcat în backstage.",
    centerstageStrategySummary: [
      {
        period: "Autonom",
        mandatory: ["parcarea robotului în backstage"],
        optional: ["lăsarea pixelului pre-încărcat în backstage"],
        scoring: "5 - 8 pct",
      },
      {
        period: "Teleop",
        mandatory: ["plasarea cât mai multor pixeli pe backdrop"],
        optional: [
          "plasarea pixelului în backstage",
          "formarea de mozaicuri",
          "trecerea liniilor pe backdrop",
        ],
        scoring: "9 - 15 pct",
      },
      {
        period: "Finalul Jocului",
        mandatory: ["lansarea dronei", "parcarea robotului în backstage"],
        optional: [],
        scoring: "5 - 35 pct",
      },
    ],
    ...
    centerstageTeleOp:
      "Șoferii navighează prin truss sau ușa scenei pentru a colecta pixeli de la stive sau stația umană. Livrăm câte un pixel pe rând către backdrop. Dacă un pixel cade în backstage, îl lăsăm și luăm altul. Scopul nostru este să formăm mozaicuri și să traversăm linii pe backdrop pentru puncte bonus.",
    centerstageEndgame:
      "Continuăm să marcăm pixeli timp de 15-20 secunde, apoi lansăm drona și parcăm în backstage pentru puncte suplimentare.",
    intoTheDeepGoal:
      "Marcați cât mai multe puncte posibil colectând mostre și marcând în coșuri/camere, apoi urcați pe submersibil.",
    intoTheDeepAutonomousDetails:
      "Robotul pornește din zona de observație lângă submersibil. Folosind navigare bazată pe timp, se deplasează la centrul submersibilului (~1.5s), colectează o mostră, apoi livrează în zona de plasă (~2.0s total). Mostra lăsată în zona de plasă aduce 2 puncte. Timpul total autonom este aproximativ 3.5 secunde.",
    intoTheDeepTeleOpDetails:
    ...
    intoTheDeepEndgameDetails:
      "Continuați să marcați mostre în coșul înalt până când rămân 15-20 secunde. În ultimele secunde, parcați robotul în zona de plasă (3 pct) sau încercați o ascensiune de nivel jos pe scara submersibilului (15 pct) dacă timpul permite.",
    intoTheDeepStrategySummary: [
      {
        period: "Autonom",
        mandatory: [
          "parcarea robotului în zona de plasă sau urcarea pe nivelul 1",
        ],
        optional: ["plasarea mostrei în zona de plasă"],
        scoring: "3 pct",
      },
      {
        period: "Teleop",
        mandatory: ["plasarea cât mai multor mostre în coșul înalt"],
        optional: ["plasarea mostrelor în coșul jos"],
        scoring: "24 - 48 pct",
      },
      {
        period: "Finalul Jocului",
        ...
        optional: ["urcarea pe nivelul 2"],
        scoring: "3 - 15 pct",
      },
    ],
    intoTheDeepTeleOp:
      "Navigăm pentru a lua câte o mostră pe rând de pe teren sau din submersibil. Mostrele sunt plasate în coșul cel mai înalt din zona de plasă. Dacă o mostră cade, o abandonăm și luăm una nouă pentru a maximiza eficiența punctajului.",
    intoTheDeepEndgame:
      "Continuăm să marcăm în coșul înalt până în ultimele secunde, apoi parcăm în zona de plasă pentru puncte suplimentare.",
    ...
    centerstageIntakeEvolution:
      "Prima versiune era o colectare dinamică cu ax rotativ și cap de perie de toaletă împingând pixeli pe o rampă în depozit cu două pixeli. Abandonată din cauza lipsei de motoare (toate 4 folosite de trenul de rulare, fără expansion hub). A doua versiune folosea o gheară cu un singur pixel cu servo de poziție și roată dințată—mai precisă dar necesita aliniere exactă. A treia versiune avea o gheară deschizându-se în unghi folosind două roți dințate angrenate, făcând colectarea pixelilor mai ușoară.",
    centerstageArmEvolution:
      "Braț inspirat de pantograf (ca pantografele de tramvai) menține unghiul de colectare constant la ridicare sau coborâre, eliminând nevoia de reajustare constantă. Inițial alimentat de unul, apoi două servo-uri cu rotație continuă (cuplu insuficient cauzând atârnare). Mai târziu actualizat la un motor Tetrix 40:1 după obținerea Expansion Hub-ului.",
    centerstageLauncherEvolution:
      "Placă subțire cu trei canale pentru dronă, bandă elastică și tijă glisantă. Elasticul este ținut sub tensiune de tijă; eliberarea acesteia lansează drona către zonele de punctaj. Tija este atașată de un servo de poziție, armată în timpul auto/tele-op și eliberată în endgame. A doua versiune a îmbunătățit montarea cu găuri personalizate în șasiu.",
    intoTheDeepFirstVersion:
      "Designul inițial avea mai multe probleme: gheară supradimensionată care nu se putea închide complet (specimene cădeau des), colectare grea folosind lame de material de măcelărie pentru a trage mostre în depozit (prea grea, acționa ca obstacol la mișcarea înainte, lamele se aliniau des și nu reușeau să apuce), glisieră viper orizontală cu motor instabil decentrat și puține puncte de susținere, glisieră viper verticală pentru coșuri și submersibil (decentrată, dificil de atașat o gheară potrivită), și o cutie de depozitare care nu ajungea la coș cu spațiu insuficient.",
    intoTheDeepUpgradeAttempts:
      "Am reproiectat forma ghearei pentru a se potrivi mai bine specimenelor, dar laturile nu se aliniază bine, făcând prinderea dificilă. La prima întâlnire, colectarea s-a blocat pe marginea zonei submersibilului. Sistemul era prea lent, greu și fragil. Am ales să nu folosim gheara din cauza acestor probleme.",
    intoTheDeepCurrentVersion:
      "Design simplificat cu o singură glisieră verticală și braț atașat. Fără transfer între containere—colectarea apucă mostra și glisiera ridică direct la coșul înalt. Beneficii: ajungem ușor la coșul înalt, colectare mai ușoară dar mai durabilă, alinierea dreaptă ajută la punctaj precis. Provocare rămasă: mișcarea brațului din cauza atașării imperfecte a motorului hex la glisieră.",
    intoTheDeepConstructionImprovements:
      "Colectare stabilizată cu două părți structurale suplimentare. Înlocuite lamele de măcelărie și adăugate opritori pentru a preveni rotația paralelă. Create discuri imprimate 3D cu centre hexagonale pentru a fixa lamele pe ax, rezolvând problemele de rotație.",

    // Programming content
    programmingDescription:
      "Ambele sezoane au folosit autonom bazat pe timp deoarece nu aveam camere sau senzori. Mișcările sunt secvențe de deplasări înainte/înapoi/stânga/dreapta cu durată fixă. Uneori folosim putere redusă la final pentru a asigura parcarea completă în zonă sau backstage.",
    driverLayoutDescription:
      "Centerstage: Inițial un singur șofer gestiona toate sarcinile din cauza problemelor de alimentare cu două gamepad-uri (Motorola G4 Play). Cu un telefon nou (Nokia 5), am împărțit sarcinile între șoferul 1 (mișcare + braț/lansator) și șoferul 2 (colectare). Into the Deep: Șoferul 1 controlează mișcarea robotului și extensia glisierei; șoferul 2 controlează colectarea, evacuarea și brațul.",

    // Outreach content
    socialMediaDescription:
      "Platformele noastre principale sunt Instagram și TikTok. Împărtășim regulat actualizări de progres, conținut din culise și puncte culminante ale competiției. Ne implicăm activ cu alte echipe prin comentarii, felicitări și promovarea evenimentelor. Ca rezultat, multe echipe recunosc deja Mechabyte la întâlniri.",
    outreachEvents: [
      {
        name: "Seară de Film (Singur Acasă 1)",
        description:
          "Eveniment de strângere de fonduri la Paradis International College cu prezentarea robotului și discuții informale STEM.",
      },
      {
        name: "Inițiativa Dulciuri și Cărți",
        description:
          "Donat dulciuri și cărți copiilor în nevoie, combinat cu discuții informale despre robotică și valori STEM.",
      },
      {
        name: "Paradis Run (2 noiembrie)",
        description:
          "Eveniment caritabil pentru Asociația Oameni Mici—echipa a alergat și a făcut voluntariat.",
      },
      {
        name: "Festivalul Științific Nikola Tesla",
        description:
          "Colaborare cu echipele Cyliis și Peppers, schimbând sfaturi despre FTC.",
      },
      {
        name: "Winter Dive Meet Iași",
        description:
          "Cooperare cu echipe regionale precum Cyliis, Peppers și Robozzi. Marcat 3 din 6 meciuri.",
      },
      {
        name: "Vânzare Clătite și Deserturi",
        description:
          "Strângere de fonduri sezon Centerstage care a adunat aproximativ 5.000 RON.",
      },
      {
        name: "Decorațiuni Târg de Crăciun",
        description:
          "Vândut decorațiuni la târgul de Crăciun, strângând încă 2.000 RON.",
      },
      {
        name: "Robotică și AI STEMPOSSUM",
        description:
          'Colaborare cu Cyliss și Universitatea Tehnică "Gheorghe Asachi".',
      },
      {
        name: "Salonul UGAL Inventics",
        description:
          "Participat cu echipa RoSophia, prezentând robotul și inovațiile noastre.",
      },
    ],
    fundraisingDescription:
      "Activitățile noastre de strângere de fonduri din ambele sezoane au inclus vânzarea de biscuiți, bilete pentru Seara de Film, clătite, decorațiuni și flori. Aceste evenimente au fost cruciale în susținerea costurilor operaționale și participarea la competiții.",
    sustainabilityDescription:
      "Planul nostru de sustenabilitate se concentrează pe: recrutarea și instruirea studenților mai tineri pentru a asigura continuitatea, menținerea rețelei de suport a absolvenților, parteneriat cu corporații care împărtășesc valorile noastre și bugetare atentă cu categorii pentru cheltuieli echipă (roți, cabluri, electronice) și fonduri de urgență. Sponsorii principali includ Paradis International College, Professional Dentist și alții care cred în misiunea noastră.",
    ...
    centerstageEvents: [
      {
        name: "Seară de Film",
        shortDescription:
          "Eveniment de strângere de fonduri cu prezentarea robotului",
        fullDescription:
          "Seara noastră anuală de film a reunit studenți, familii și membri ai comunității pentru o seară de divertisment și robotică. Am instalat robotul nostru CenterStage pentru demonstrații între proiecții, permițând participanților să vadă robotul în acțiune și să învețe despre FIRST Tech Challenge.",
        impact:
          "Am strâns fonduri pentru echipă și am introdus peste 50 de membri ai comunității în robotica FTC. Mulți și-au exprimat interesul de a susține eforturile noastre viitoare.",
        date: "Toamna 2023",
      },
      {
        ...
        fullDescription:
          "Membrii echipei au organizat o vânzare de clătite la școală, preparând și servind clătite făcute în casă pentru studenți, profesori și părinți. Acest efort de strângere de fonduri de la bază a necesitat coordonare, marketing prin social media și implicarea directă a tuturor membrilor echipei.",
        impact:
          "Am generat aproximativ 5.000 RON (~€1.000) pentru a finanța piese de robot, taxe de competiție și materiale pentru echipă. Am construit unitatea echipei prin muncă colaborativă.",
      ...
      },
      {
        ...
        fullDescription:
          "Mechabyte a participat la Paradis Run anual, un eveniment caritabil organizat de școala noastră. Membrii echipei au alergat împreună purtând tricouri de echipă, promovând sănătatea, fitness-ul și spiritul școlar, ridicând în același timp gradul de conștientizare despre programul nostru de robotică.",
        impact:
          "Am întărit legăturile cu comunitatea școlară și am crescut vizibilitatea echipei de robotică în rândul studenților și profesorilor. Mai mulți membri noi s-au alăturat după ce ne-au văzut la eveniment.",
        date: "Primăvara 2024",
      },
      {
        ...
        fullDescription:
          "Am călătorit la Festivalul Nikola Tesla, o expoziție regională de știință și inovație. Lucrând alături de alte echipe FTC din România, am demonstrat robotul nostru, am împărtășit cunoștințe de inginerie și ne-am implicat cu sute de studenți interesați de domeniile STEM.",
        impact:
          "Ne-am conectat cu alte 3 echipe FTC pentru a împărtăși cunoștințe și strategii. Am inspirat numeroși studenți să exploreze robotica și ingineria. Am stabilit relații de colaborare continuă.",
        date: "Primăvara 2024",
      },
    ],
    ...
    intoTheDeepEvents: [
      {
        ...
        fullDescription:
          "Prima noastră competiție oficială pentru sezonul Into the Deep a avut loc la Iași. Deși suntem o echipă tânără, am concurat în 6 meciuri de calificare, punctând cu succes în 3 dintre ele. Experiența a oferit lecții neprețuite în strategia de competiție, selecția alianțelor și profesionalismul grațios.",
        impact:
          "Am câștigat experiență critică de competiție. Am identificat punctele slabe ale robotului, conducând la proiecte îmbunătățite. Am construit relații cu partenerii de alianță și echipele adversare.",
        date: "Ianuarie 2025",
      },
      {
        name: "STEMPOSSUM",
      ...
      },
      {
        ...
        fullDescription:
          "Membrii echipei au creat manual decorațiuni de Crăciun, inclusiv ornamente, coroane și felicitări cu design-uri tematice robotice. Am amenajat un stand la târgul local de Crăciun, combinând spiritul sărbătorilor cu conștientizarea roboticii. Toate veniturile au mers direct la bugetul echipei.",
        impact:
          "Am generat 2.000 RON (~€400) pentru cheltuielile echipei. Am demonstrat creativitate dincolo de abilitățile tehnice. Ne-am implicat cu peste 200 de vizitatori despre FTC.",
        date: "Decembrie 2024",
      },
    ],
  },
