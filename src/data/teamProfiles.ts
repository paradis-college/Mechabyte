...
export const teamProfiles: Record<string, TeamMemberProfile> = {
  ...
  "Ianis Cotoc": {
    ...
    philosophy:
      "Great robots are built by great teams. Leadership is about empowering every member to contribute their best work.",
    skills: [
  ...
  "David Grigore": {
    ...
    philosophy:
      "Design is not just how it looks, but how it works. Every component should have a purpose and function beautifully.",
    skills: [
  ...
  "Ștefan Albu": {
    ...
    philosophy:
      "Reliability is non-negotiable. A robot that works 99% of the time still fails when it matters most.",
    skills: [
  ...
  "Alexia Vancea": {
    ...
    philosophy:
      "Technology should be accessible and exciting. Great engineering deserves great storytelling.",
    skills: [
  ...
  "Teodor Matricală": {
    ...
    philosophy:
      "The whole is greater than the sum of its parts. Integration is where magic happens.",
    skills: [
      "Java programming",
  ...
  "Catrinel Bănuță": {
    ...
    philosophy:
      "Every expert was once a beginner. Learning never stops, and mistakes are opportunities to grow.",
    skills: [
  ...
  "Alexandra Maftei": {
    ...
    philosophy:
      "Impact is measured not just by what we build, but by who we inspire and the communities we serve.",
    skills: [
  ...
  "Veronika Glazkova": {
    ...
    philosophy:
      "Creativity connects hearts and minds. Our story deserves to be told beautifully.",
    skills: [
  ...
  "Cristiana Balan": {
    ...
    philosophy:
      "Design is intelligence made visible. Every visual element should communicate purpose and passion.",
    skills: [
  ...
  "Alexandra Sîmbotin Gășpărel": {
    ...
    philosophy:
      "Community is our foundation. Every connection we make today plants seeds for tomorrow.",
    skills: [
      "Event coordination",
      "Community outreach",
  ...
  "Andreea Ioniță": {
    ...
    philosophy:
      "Mentorship is about asking the right questions, not giving all the answers. Growth comes from guided discovery.",
    skills: [
  ...
  "Tudor Tocila": {
    ...
    philosophy:
      "Success in robotics requires both technical excellence and business savvy. Understanding markets, sponsors, and strategy is equally important.",
    skills: [
  ...
  "Sebastian Rosca": {
    ...
    philosophy:
      "Excellence is a journey, not a destination. Every competition is a chance to learn and improve.",
    skills: [
  ...
  "Bobu Dragos": {
    ...
    philosophy:
      "A great website tells your story and opens doors. Code should be clean, accessible, and performant.",
    skills: [
