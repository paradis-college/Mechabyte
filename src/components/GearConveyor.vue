...
onMounted(() => {
  if (
    ...
    foregroundGearRef.value &&
    midgroundGearRef.value &&
    backgroundGearRef.value
  ) {
...
<template>
  ...
  >
    ...
    >
      ...
      <path
        d="M 20 15 L 20 12 L 70 12 L 70 10"
        class="circuit-line circuit-line--1"
      />
      <!-- Top right to middle left -->
      <path
        d="M 70 10 L 75 10 L 75 48 L 15 48 L 15 55"
        class="circuit-line circuit-line--2"
      />
      <!-- Middle to bottom left -->
      <path
        d="M 10 50 L 8 50 L 8 82 L 25 82 L 25 85"
        class="circuit-line circuit-line--3"
      />
      <!-- Middle right to bottom right -->
      <path
        d="M 80 55 L 82 55 L 82 88 L 65 88 L 65 90"
        class="circuit-line circuit-line--4"
      />
      <!-- Top section cross connection -->
      <path
        d="M 20 15 L 18 15 L 18 22 L 60 22 L 60 20"
        class="circuit-line circuit-line--5"
      />
      <!-- Middle section horizontal -->
      <path
        d="M 40 60 L 40 65 L 75 65 L 75 80"
        class="circuit-line circuit-line--6"
      />
      <!-- Bottom section connection -->
      <path
        d="M 25 85 L 30 85 L 30 88 L 55 88 L 55 92"
        class="circuit-line circuit-line--7"
      />
      <!-- Vertical connector on right -->
      <path
        d="M 80 55 L 85 55 L 85 35 L 85 35"
        class="circuit-line circuit-line--8"
      />
      <!-- Cross connection middle to top -->
      <path
        d="M 50 48 L 50 35 L 25 35 L 25 25"
        class="circuit-line circuit-line--9"
      />
      <!-- Diagonal-style Manhattan route -->
      <path
        d="M 15 18 L 10 18 L 10 45 L 40 45 L 40 60"
        class="circuit-line circuit-line--10"
      />
    </svg>
    ...
    <div ref="backgroundGearRef" class="gear-layer gear-layer--background">
      <!-- Top section -->
      <svg
        class="gear gear--large gear--slow"
      ...
      >
        ...
        />
        <path
          d="M50 10 L55 20 L50 30 L45 20 Z M90 50 L80 55 L70 50 L80 45 Z M50 90 L45 80 L50 70 L55 80 Z M10 50 L20 45 L30 50 L20 55 Z M73 27 L68 35 L60 32 L65 24 Z M73 73 L65 76 L60 68 L68 65 Z M27 73 L32 68 L40 73 L35 76 Z M27 27 L35 24 L40 32 L32 35 Z"
          fill="var(--gear-accent)"
          opacity="0.1"
        />
      </svg>
      <svg
        class="gear gear--large gear--reverse"
    ...
    <div ref="midgroundGearRef" class="gear-layer gear-layer--midground">
      ...
      >
        ...
        />
        <path
          d="M50 15 L54 23 L50 31 L46 23 Z M85 50 L77 54 L69 50 L77 46 Z M50 85 L46 77 L50 69 L54 77 Z M15 50 L23 46 L31 50 L23 54 Z M70 30 L66 37 L59 34 L63 27 Z M70 70 L63 73 L59 66 L66 63 Z M30 70 L34 66 L41 70 L37 73 Z M30 30 L37 27 L41 34 L34 37 Z"
          fill="var(--gear-accent)"
          opacity="0.14"
        />
      </svg>
      <svg
        class="gear gear--medium gear--reverse"
    ...
    <div ref="foregroundGearRef" class="gear-layer gear-layer--foreground">
      <!-- Top -->
      <svg
        class="gear gear--small gear--fast"
      ...
      >
        ...
        />
        <path
          d="M50 20 L53 27 L50 34 L47 27 Z M80 50 L73 53 L66 50 L73 47 Z M50 80 L47 73 L50 66 L53 73 Z M20 50 L27 47 L34 50 L27 53 Z M67 33 L64 39 L58 36 L61 30 Z M67 67 L61 70 L58 64 L64 61 Z M33 67 L36 64 L42 67 L39 70 Z M33 33 L39 30 L42 36 L36 39 Z"
          fill="var(--gear-accent)"
          opacity="0.18"
        />
      </svg>
